...
public class BaseStaxWriter {
    ...
    protected XMLInputFactory2 getFactory()
    {
        ...
        f.setProperty(XMLInputFactory.IS_NAMESPACE_AWARE, Boolean.FALSE);//FALSE
        f.setProperty(XMLInputFactory.SUPPORT_DTD, Boolean.FALSE);//FALSE
    ...
    {
        XMLOutputFactory f =  XMLOutputFactory2.newInstance();
